...
(function ($, window, document, undefined) {
    ...
    var Editor = {
        ...
        init: function (options, elem) {
            ...
            var placeholder = $('<textarea/>', {name: self.$elem.attr('name'), text: self.$elem.text()});
            self.$elem.replaceWith(placeholder);
            self.$elem = placeholder;

            /*self.getPlugin( 'tinymce' ).done(function () {
             // $this['tinymce']( options );
             }).fail(function () {
             console.log( 'Is not connect plugin: tinymce' );
             });*/
        ...
        Theme: function (editor, target) {
            ...
            //  | image
            var toolbar = ['bold italic | link | numlist bullist | blockquote'];
            ...
            return {
                ...
                iframeHeight: editor.settings.height //target.offsetHeight - editorContainer.firstChild.offsetHeight
        ...
        image_upload: {
            init: function (ed) {
                ...
                self.url = Editor.settings.image_upload_dest;
                // console.log(  );
                // Editor.settings
