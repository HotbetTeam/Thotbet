	...
	<header class="SettingCol_header" data-elem="header">
		<div class="settings-content-title clearfix">
			<div class="rfloat settings-content-title-actions">
				<a data-plugins="dialog" href="<?=URL?>users/add?access_id=1" class="btn btn-primary"><i class="icon-plus mrs"></i><span>เพิ่ม</span></a>
			</div>
			<div>ผู้ดูแลระบบ</div>
		</div>
		<div class="settings-content-description">เพิ่มและจัดการสิทธิ์การทำงาน</div>
	</header>
			...
			<tr>
				...
				?>
					...
					<span class="group-btn" style="width:95px;">
						<a data-plugins="dialog" href="<?=URL?>users/edit/<?=$item['user_id'];?>?access_id=1" class="btn">แก้ไข</a>
